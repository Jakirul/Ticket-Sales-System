...
<div class="contain" style="padding: 2.15rem;">
        ...
        <div class="test" style="display: flex;align-items: center;justify-content: center;">
                ...
                <!-- nav title bar --> 
                    <li style="font-size: 25px;"><strong>Office Manager Login</strong></li>
                    ...
                    <div id="container" >
                        ...
                        <!-- login title --> 
                            ...
                            <form  class="user" action="code2.php" method="post">
                                ...
                                <div class="form-group" style="margin-bottom: 15px">
                                    <input style="text-align: center" type="hidden" value="OFFICE_MANAGER" id="usertype" name="usertype111" readonly>
                                </div>
