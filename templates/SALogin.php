...
<div class="contain" style="padding: 2.15rem;">
        ...
        <div class="test" style="display: flex;align-items: center;justify-content: center;">
                <ul style="list-style: none;">
                 <!-- nav title bar --> 
                    <li style="font-size: 25px;"><strong>System Admin Login</strong></li>
                    ...
                    <div id="container">
                        ...
                        <!-- login title --> 
                            ...
                            <form  class="user" action="code1.php" method="post">
                                ...
                                <div class="form-group" style="margin-bottom: 15px">
                                    <input style="text-align: center" type="hidden" value="SYSTEM_ADMIN" id="usertype" name="usertype111" readonly>
                                </div>
                    
                                <div>
                                 <!-- login button --> 
                                    <button type="submit" name="login_btn1">Log in</button>
                                </div>
                            </form>
                        </div>
                    </div>
