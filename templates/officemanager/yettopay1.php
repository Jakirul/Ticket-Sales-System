...
<head>
  <!-- header.php is just a few header codes. I added it so i don't have to keep repeating myself in every file. -->
    <?php include('../../partials/header.php') ?>  
     <!-- title -->  
    <title>Yet to Pay List</title>
    <script src="https://code.jquery.com/jquery-2.1.1.min.js" type="text/javascript"></script>
</head>
<script>
//javascript function to get the amount
    ...
    <div class="contain" style="padding: 1.8rem;">
            ...
            <ul>
              <!-- Navigation bar -->
                ...
                <li><a href="yettopay.php"  class="present">Yet to Pay</a></li>
        ...
        <div class="row">
            <div class="col-25">
            <!-- drop down list for the amount due -->
      ...
      <!-- submit payment button  -->
          <button onclick="location.href='#'" type="submit" name="yetopaybtn">Submit Payment</button>
