...
<head>
    ...
    <script src="https://code.jquery.com/jquery-2.1.1.min.js" type="text/javascript"></script>
     <!-- title --> 
    <title>Interline Tickets</title>
</head>
 <!-- javascript code to allow you to type in other names apart from the ones in the customer table --> 
...
// code to get the  rate for local tax
   ...
   <nav id="main-nav">
    ...
    <header id="showcase">
        <div class="contain">
          ...
          <!-- Form  -->        
      <form action="../code.php" method="POST" style="color: black" >
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-25">
           <!-- Hidden interline text field -->
          </div>
          <div class="col-75">
          <input type="hidden" id="Interline" name="type1"  minlength="1" maxlength="25" value="Interline" required>
          </div>
        </div>
        ...
        <div class="row">
        <!-- blank type and number dropdown field which was retreived from the assignblank table -->
          <div class="col-25">
        ...
        <?php
          ...
          <div class="row">
          <!-- customer name dropdown field that was retreived from the customer db -->
          <div class="col-25">
     ...
     <option value=""></option>
        ...
        <div class="row">
          ...
          <!-- amount LC field-->
            ...
            <!-- curreny codes retreived from the db -->
          ...
          <div class="row">
            ...
            <div class="col-75"  style="float:left; max-width: 266.666667px;">
              <input type="text" id="localtax" name="localtax" placeholder="Local Tax"  required> 
            </div>
            <div class="col-75"  style="float:left; max-width: 266.666667px;">
              <input type="text" id="othertax" name="othertax" placeholder="Other Tax"   required onkeyup="getDiscount2(this.value);" >
            </div>
            <div class="col-75"   style="float:right; margin-left: 10px; max-width: 266px;">
          ...
          <div class="row">
          <!-- submission button -->
          <input style="margin-top: 10px; " name="sellticketbtn2" type="submit" value="Submit">
          </div>
